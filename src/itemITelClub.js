...
export default ItemITelClub = () =>{
    return(
        <ScrollView horizontal style={{marginTop:16,marginLeft:20}}>
                ...
                <View style={{flexDirection:'row',width: '90%',}}>
                    ...
                    <View style={{height:37,justifyContent:'center',marginBottom: 19, }}>
                        <View  style={{flexDirection:'row', alignItems:'center'}}>
                            <Image source={require('../src/img/Home/coin.jpg')} style={{width:11, height:10,marginRight:4}}/>
                            <Text style={{fontSize: 12,lineHeight:14.06,color:'#ED1F24'}}>200 điểm</Text>
                        </View>

                        <View  style={{flexDirection:'row', alignItems:'center'}}>
                            <Image source={require('../src/img/Home/date.jpg')} style={{width:11, height:11,marginRight:4}}/>
