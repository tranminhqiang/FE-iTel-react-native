        ...
        <ScrollView horizontal style={{marginTop:16,marginLeft:19}}>
            <TouchableOpacity style={styles.item}>
                ...
                <View style={{flexDirection:'row',width: '90%',}}>
                    <Text style={{fontSize:12,lineHeight:14}}>Phim dài tập</Text>
                </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.item}>
                ...
                <View style={{flexDirection:'row',width: '90%',}}>
                    <Text style={{fontSize:12,lineHeight:14}}>Game show</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={styles.item}>
                <View style={{width:'100%',height:156,backgroundColor:'#C4C4C4',borderRadius:4}}></View>
                ...
                <View style={{flexDirection:'row',width: '90%',}}>
                    <Text style={{fontSize:12,lineHeight:14}}>Hài</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={styles.item}>
                <View style={{width:'100%',height:156,backgroundColor:'#C4C4C4',borderRadius:4}}></View>
